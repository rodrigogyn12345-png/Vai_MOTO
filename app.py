...
.pub-card label {
    font-size:19px !important;
      ...
      <div class="pub-card">
        ...
        <button class="pub-btn pub-blue" type="button" onclick="(function(){var s=document.createElement('script');s.src='/static/passageiro.js?v=4';s.onload=function(){alert('JS DINAMICO OK')};s.onerror=function(){alert('ERRO JS DINAMICO')};document.head.appendChild(s)})()">🎯 USAR MINHA LOCALIZAÇÃO</button>
